...
namespace QnABot.Attributes
{
    public class LineSignature : AuthorizeAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            if (Request.Headers.TryGetValues("X-Line-Signature", out headerValues))
            {
                ...
                byte[] screct = Encoding.UTF8.GetBytes(ConfigurationManager.AppSettings["LineChannelSecret"]),
